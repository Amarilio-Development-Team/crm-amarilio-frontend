...
import { searchCustomerForProspectAction } from '../../../actions/search-customer-for-prospect.action';
...
import { StepOneSchema } from '@/features/prospects/models/step-one.model';
import { clientOptions, type ClientCardOption } from '@/features/prospects/constants/client-options';
...
export const Step1ClientSelection: React.FC = () => {
  ...
  const handleSearch = async (query: string) => {
    ...
    setIsSearching(true);
    setHasSearched(true);
    const results = await searchCustomerForProspectAction(query);
